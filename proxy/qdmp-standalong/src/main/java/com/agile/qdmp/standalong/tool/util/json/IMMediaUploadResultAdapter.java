 ...
 * @Date: 2022/9/7 11:35
 */
public class IMMediaUploadResultAdapter implements JsonDeserializer<IMMediaUploadResult> {

    @Override
    public IMMediaUploadResult deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        IMMediaUploadResult result = new IMMediaUploadResult();
