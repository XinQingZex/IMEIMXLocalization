package com.agile.qdmp.standalong.config.properties;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.stereotype.Component;

/**
 * @Description: Properties for UAA-based OAuth2 security.
 * @Author: wenbinglei
 * @Date: 2021/4/2 17:02
 */
@Component
...
public class UaaProperties {
    ...
    public static class WebClientConfiguration {
        ...
        private int accessTokenValidityInSeconds = 30 * 60;
        //validity of the refresh token in secs (defines the duration of "remember me")
        private int refreshTokenValidityInSecondsForRememberMe = 15 * 24 * 60 * 60;
